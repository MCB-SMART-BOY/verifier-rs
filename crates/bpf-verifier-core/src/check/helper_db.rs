...
pub static HELPER_DB: &[HelperDef] = &[
    ...
    HelperDef::new(
        BpfFuncId::GetCurrentCgroupId,
        "get_current_cgroup_id",
        INT,
        NO_ARGS,
    ),
    HelperDef::new(
        BpfFuncId::GetCurrentAncestorCgroupId,
        "get_current_ancestor_cgroup_id",
        INT,
        args(ANY, NONE, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::GetNsCurrentPidTgid,
    ...
    .with_flags(HelperFlags::pkt()),
    HelperDef::new(
        BpfFuncId::SkbLoadBytesRelative,
    ...
    HelperDef::new(
        BpfFuncId::SkbGetTunnelKey,
        "skb_get_tunnel_key",
        INT,
        args(CTX, UNINIT, SIZE, ANY, NONE),
    ),
    HelperDef::new(
        BpfFuncId::SkbSetTunnelKey,
        "skb_set_tunnel_key",
        INT,
        args(CTX, MEM, SIZE, ANY, NONE),
    ),
    HelperDef::new(
        BpfFuncId::SkbGetTunnelOpt,
        "skb_get_tunnel_opt",
        INT,
        args(CTX, UNINIT, SIZE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::SkbSetTunnelOpt,
        "skb_set_tunnel_opt",
        INT,
        args(CTX, MEM, SIZE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::SkbGetXfrmState,
        "skb_get_xfrm_state",
        INT,
        args(CTX, ANY, UNINIT, SIZE, ANY),
    ),
    ...
    // =========== Socket Options ===========
    HelperDef::new(
        BpfFuncId::Setsockopt,
        "setsockopt",
        INT,
        args(CTX, ANY, ANY, MEM, SIZE),
    ),
    HelperDef::new(
        BpfFuncId::Getsockopt,
        "getsockopt",
        INT,
        args(CTX, ANY, ANY, UNINIT, SIZE),
    ),
    HelperDef::new(
        BpfFuncId::GetSocketCookie,
        "get_socket_cookie",
        INT,
        args(CTX, NONE, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::GetSocketUid,
        "get_socket_uid",
        INT,
        args(CTX, NONE, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::GetNetnsCookie,
        "get_netns_cookie",
        INT,
        args(CTX, NONE, NONE, NONE, NONE),
    ),
    ...
    HelperDef::new(
        BpfFuncId::LoadHdrOpt,
        "load_hdr_opt",
        INT,
        args(CTX, UNINIT, SIZE, ANY, NONE),
    ),
    HelperDef::new(
        BpfFuncId::StoreHdrOpt,
        "store_hdr_opt",
        INT,
        args(CTX, MEM, SIZE, ANY, NONE),
    ),
    HelperDef::new(
        BpfFuncId::ReserveHdrOpt,
        "reserve_hdr_opt",
        INT,
    ...
    // =========== TCP ===========
    HelperDef::new(
        BpfFuncId::TcpCheckSyncookie,
        "tcp_check_syncookie",
        INT,
        args(SOCK, MEM, ANY, MEM, ANY),
    ),
    HelperDef::new(
        BpfFuncId::TcpGenSyncookie,
        "tcp_gen_syncookie",
        INT,
        args(SOCK, MEM, ANY, MEM, ANY),
    ),
    ...
    // =========== Signal ===========
    HelperDef::new(
        BpfFuncId::SendSignal,
        "send_signal",
        INT,
        args(ANY, NONE, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::SendSignalThread,
        "send_signal_thread",
        INT,
        args(ANY, NONE, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::OverrideReturn,
        "override_return",
        INT,
        args(CTX, ANY, NONE, NONE, NONE),
    )
    ...
    HelperDef::new(
        BpfFuncId::TimerSetCallback,
        "timer_set_callback",
        INT,
        args(TIMER, FUNC, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::TimerStart,
        "timer_start",
        INT,
        args(TIMER, ANY, ANY, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::TimerCancel,
        "timer_cancel",
        INT,
    ...
    HelperDef::new(
        BpfFuncId::GetAttachCookie,
        "get_attach_cookie",
        INT,
        args(CTX, NONE, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::GetBranchSnapshot,
        "get_branch_snapshot",
        INT,
        args(UNINIT, SIZE, ANY, NONE, NONE),
    ),
    ...
    HelperDef::new(
        BpfFuncId::ImaInodeHash,
        "ima_inode_hash",
        INT,
        args(BTF, UNINIT, SIZE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::ImaFileHash,
        "ima_file_hash",
        INT,
        args(BTF, UNINIT, SIZE, NONE, NONE),
    ),
    ...
    // Redirect neighbors
    HelperDef::new(
        BpfFuncId::RedirectNeigh,
        "redirect_neigh",
        INT,
        args(ANY, MEM, SIZE, ANY, NONE),
    ),
    HelperDef::new(
        BpfFuncId::RedirectPeer,
        "redirect_peer",
        INT,
        args(ANY, ANY, NONE, NONE, NONE),
    ),
    ...
    HelperDef::new(
        BpfFuncId::GetFuncArg,
        "get_func_arg",
        INT,
        args(CTX, ANY, STK, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::GetFuncRet,
        "get_func_ret",
        INT,
        args(CTX, STK, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::GetFuncArgCnt,
        "get_func_arg_cnt",
        INT,
        args(CTX, NONE, NONE, NONE, NONE),
    ),
    ...
    HelperDef::new(
        BpfFuncId::XdpGetBuffLen,
        "xdp_get_buff_len",
        INT,
        args(CTX, NONE, NONE, NONE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::XdpLoadBytes,
        "xdp_load_bytes",
        INT,
        args(CTX, ANY, UNINIT, SIZE, NONE),
    ),
    HelperDef::new(
        BpfFuncId::XdpStoreBytes,
        "xdp_store_bytes",
        INT,
        args(CTX, ANY, MEM, SIZE, NONE),
    ),
...
pub fn helpers_for_prog_type(prog_type: BpfProgType) -> impl Iterator<Item = &'static HelperDef> {
    HELPER_DB
        .iter()
        .filter(move |h| helper_available_for_prog(h, prog_type))
}
